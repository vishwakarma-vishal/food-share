...
export const Distribution = () => {
  ...
  return (
    <div className="h-full">
      <h2 className="font-semibold text-lg sm:text-xl md:text-2xl">Distribution History</h2>
      <div className="bg-green-100 text-green-900 my-4 p-4 rounded-lg shadow-sm text-xs sm:text-sm">
          ...
          <div className="h-full">
            {/* data */}
            {
              distributionHistory.length === 0 ?
                <div className="text-gray-500 flex justify-center items-center h-full text-center text-sm sm:text-base">
                ...
                <div className="flex flex-col gap-4">
...

                  {
                    currentHistory.length === 0 ?
                      <div className="text-gray-500 mt-10 flex justify-center items-center text-sm sm:text-base text-center">
