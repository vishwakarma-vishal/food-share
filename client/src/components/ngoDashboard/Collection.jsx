...
export const Collection = () => {
  ...
  const applyFilter = () => {
    ...
    if (searchTerm != "") {
      const newArray = filteredListings.filter(item =>
        ...
        item.foodListingId.restaurantId.name.toLowerCase().includes(searchTerm.toLowerCase()));
  ...
  return (
    <div className="h-full">
      <h2 className="font-semibold text-lg sm:text-xl md:text-2xl">Collection History</h2>
        ...
        <div className='mt-4 h-full'>
          {/* data */}
          {
            collectionHistory.length === 0 ?
              <div className="text-gray-500 flex justify-center items-center h-full text-sm sm:text-base">
              ...
              <div className="relative text-sm sm:text-base">
                <div>
                    ...
                    <form className="flex flex-wrap items-center gap-4">
                      <div className="flex gap-2 sm:gap-4 items-center">
                        ...
                        <input
                          ...
                          className="p-2 w-full sm:w-56 text-sm rounded-lg border outline-none"
                  ...
                  {/* notice */}
                  <div className="bg-red-100 text-red-600 my-6 p-4 rounded-lg shadow-sm text-xs sm:text-sm">
                  ...
                  {currentHistory.length === 0 ?
                    ...
                    <div>
                      ...
                      {/* table */}
                      <table className="w-full rounded-lg border-collapse shadow-xl bg-white text-xs sm:text-sm">
                        <thead>
                      ...
                      {/* pagination */}
                      <div className="flex gap-4 items-center mt-6 text-sm sm:text-base">
