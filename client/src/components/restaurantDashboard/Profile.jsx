        ...
        <div className="flex gap-6">
          ...
          <div className="flex-grow w-full">
            <div>
              ...
              <input id="name" type="text" placeholder="Enter your restaurant name..." className="border border-gray-500 w-full p-2 rounded-md my-2 outline-none" />
            </div>
        ...
        <div className="mt-4">
          <div className="flex gap-4">
            <div className="w-full">
              ...
              <div className="flex gap-4 items-center">
                <input id="foundingDate" type="time" className="border border-gray-500 w-full p-2 rounded-md my-2 outline-none" />
                to
                <input id="foundingDate" type="time" className="border border-gray-500 w-full p-2 rounded-md my-2 outline-none" />
              </div>
            </div>
          ...
          <div className="flex gap-4">
            <div className="w-full">
              ...
              <textarea id="address" rows="3" placeholder="Enter restaurant address" className="border border-gray-500 w-full p-2 rounded-md my-2 outline-none" />
            </div>
            <div className="w-full">
